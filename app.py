...
url = "https://drive.google.com/uc?export=download&id=1KfuxGsJX6faPs-QoNdADcN7wsj3K3FXm"
filename = "model.h5"
...
classes = [ "Rotten Apple", "Good Apple", "Rotten Banana","Good Banana", "Rotten Orange" , "Good Orange"] 
# load json and create model . json file is avaliable in github , but model is too large to be in git
...
st.markdown("<h3 style='text-align: center; color: green;'>Apple , Orange and Banana</h2>", unsafe_allow_html=True)
